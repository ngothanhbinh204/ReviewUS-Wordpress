...
$title_related_destination = get_field('title_related_destination');
$subtitle_related_destination = get_field('subtitle_related_destination');
$related_destination = get_field('related_destination');
...
<?php
$slider_title = isset($title_related_destination) ? $title_related_destination : '';

// Set query vars for template part
set_query_var('slide_config', array(
	'id' => 'slide_' . $index,
	'title' => $slider_title,
	'sub_title' => $subtitle_related_destination,
	'link' => "/places-to-go/",
	'link_text' => "Explore USA",
	'link_target' => $slider_button && isset($slider_button['target']) ? $slider_button['target'] : '',
	'posts' => $related_destination,
	'loop' => false
));
